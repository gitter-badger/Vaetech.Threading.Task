        ...
        public void InitParallel(Processors processors, List<T> list, T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6)
        {
            ...
            switch (processors)
            {
                ...
                case Processors.Two:
                    {
                        Parallel.Invoke(
                            () => OnSendParameters(1, list.GetRange((proceso * 0), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(2, list.GetRange((proceso * 1), list.Count - (proceso * 1)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Three:
                    {
                        Parallel.Invoke(
                            () => OnSendParameters(1, list.GetRange((proceso * 0), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(2, list.GetRange((proceso * 1), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(3, list.GetRange((proceso * 2), list.Count - (proceso * 2)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Four:
                    {
                        Parallel.Invoke(
                            () => OnSendParameters(1, list.GetRange((proceso * 0), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(2, list.GetRange((proceso * 1), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(3, list.GetRange((proceso * 2), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(4, list.GetRange((proceso * 3), list.Count - (proceso * 3)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Five:
                    {
                        Parallel.Invoke(
                            ...
                            () => OnSendParameters(2, list.GetRange((proceso * 1), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(3, list.GetRange((proceso * 2), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(4, list.GetRange((proceso * 3), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(5, list.GetRange((proceso * 4), list.Count - (proceso * 4)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Six:
                    {
                        Parallel.Invoke(
                            ...
                            () => OnSendParameters(3, list.GetRange((proceso * 2), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(4, list.GetRange((proceso * 3), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(5, list.GetRange((proceso * 4), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(6, list.GetRange((proceso * 5), list.Count - (proceso * 5)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Seven:
                    {
                        Parallel.Invoke(
                            ...
                            () => OnSendParameters(4, list.GetRange((proceso * 3), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(5, list.GetRange((proceso * 4), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(6, list.GetRange((proceso * 5), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(7, list.GetRange((proceso * 6), list.Count - (proceso * 6)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Eight:
                    {
                        Parallel.Invoke(
                            ...
                            () => OnSendParameters(5, list.GetRange((proceso * 4), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(6, list.GetRange((proceso * 5), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(7, list.GetRange((proceso * 6), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(8, list.GetRange((proceso * 7), list.Count - (proceso * 7)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Nine:
                    {
                        Parallel.Invoke(
                            ...
                            () => OnSendParameters(6, list.GetRange((proceso * 5), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(7, list.GetRange((proceso * 6), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(8, list.GetRange((proceso * 7), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(9, list.GetRange((proceso * 8), list.Count - (proceso * 8)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Ten:
                    {
                        Parallel.Invoke(
                            ...
                            () => OnSendParameters(7, list.GetRange((proceso * 6), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(8, list.GetRange((proceso * 7), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(9, list.GetRange((proceso * 8), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(10, list.GetRange((proceso * 9), list.Count - (proceso * 9)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Eleven:
                    {
                        Parallel.Invoke(
                            ...
                            () => OnSendParameters(8, list.GetRange((proceso * 7), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(9, list.GetRange((proceso * 8), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(10, list.GetRange((proceso * 9), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(11, list.GetRange((proceso * 10), list.Count - (proceso * 10)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Twelve:
                    {
                        Parallel.Invoke(
                            ...
                            () => OnSendParameters(9, list.GetRange((proceso * 8), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(10, list.GetRange((proceso * 9), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(11, list.GetRange((proceso * 10), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(12, list.GetRange((proceso * 11), list.Count - (proceso * 11)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Thirteen:
                    {
                        Parallel.Invoke(
                            ...
                            () => OnSendParameters(10, list.GetRange((proceso * 9), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(11, list.GetRange((proceso * 10), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(12, list.GetRange((proceso * 11), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(13, list.GetRange((proceso * 12), list.Count - (proceso * 12)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Fourteen:
                    {
                        Parallel.Invoke(
                            ...
                            () => OnSendParameters(11, list.GetRange((proceso * 10), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(12, list.GetRange((proceso * 11), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(13, list.GetRange((proceso * 12), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(14, list.GetRange((proceso * 13), list.Count - (proceso * 13)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Fifteen:
                    {
                        Parallel.Invoke(
                            ...
                            () => OnSendParameters(12, list.GetRange((proceso * 11), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(13, list.GetRange((proceso * 12), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(14, list.GetRange((proceso * 13), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(15, list.GetRange((proceso * 14), list.Count - (proceso * 14)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Sixteen:
                    {
                        Parallel.Invoke(
                            ...
                            () => OnSendParameters(13, list.GetRange((proceso * 12), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(14, list.GetRange((proceso * 13), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(15, list.GetRange((proceso * 14), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(16, list.GetRange((proceso * 15), list.Count - (proceso * 15)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Seventeen:
                    {
                        Parallel.Invoke(
                            ...
                            () => OnSendParameters(14, list.GetRange((proceso * 13), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(15, list.GetRange((proceso * 14), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(16, list.GetRange((proceso * 15), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(17, list.GetRange((proceso * 16), list.Count - (proceso * 16)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Eighteen:
                    {
                        Parallel.Invoke(
                            ...
                            () => OnSendParameters(15, list.GetRange((proceso * 14), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(16, list.GetRange((proceso * 15), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(17, list.GetRange((proceso * 16), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(18, list.GetRange((proceso * 17), list.Count - (proceso * 17)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Nineteen:
                    {
                        Parallel.Invoke(
                            ...
                            () => OnSendParameters(16, list.GetRange((proceso * 15), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(17, list.GetRange((proceso * 16), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(18, list.GetRange((proceso * 17), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(19, list.GetRange((proceso * 18), list.Count - (proceso * 18)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
                case Processors.Twenty:
                    {
                        Parallel.Invoke(
                            ...
                            () => OnSendParameters(17, list.GetRange((proceso * 16), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(18, list.GetRange((proceso * 17), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(19, list.GetRange((proceso * 18), proceso), item1, item2, item3, item4, item5, item6),
                            () => OnSendParameters(20, list.GetRange((proceso * 19), list.Count - (proceso * 19)), item1, item2, item3, item4, item5, item6)
                        );
                    }
                    break;
            }
